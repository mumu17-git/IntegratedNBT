...
public class NBTExtractorBE extends BlockEntity implements ICapabilityProvider,
    ...
    private PathElementTile<NBTExtractorBE> pathElementCapability = null;
    ...
    private InventoryVariableEvaluator<IValue> evaluator = new InventoryVariableEvaluator<>(
        this,
        SRC_NBT_SLOT,
        ValueDeseralizationContext.of(level),
    ...
    public IVariable<?> getSrcNBTVariable() {
        ...
        return this.evaluator.getVariable(this.networkCarrierCapability.getNetwork());
    }
    ...
    public <T> LazyOptional<T> getCapability(@Nonnull Capability<T> capability, Direction facing) {
        if (capability == Capabilities.CABLE_CAPABILITY) {
            ...
            if (this.pathElementCapability == null) {
